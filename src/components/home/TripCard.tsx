    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
          {/* Destination */}
          <div className="text-[10px] font-medium tracking-[0.2em] uppercase text-white/40 mb-2">
            {trip.destination}
          </div>

          {/* Title in display font */}
          <h3 className="font-display text-[1.65rem] sm:text-[1.85rem] font-light italic text-white leading-tight mb-3 group-hover:text-white/90 transition-colors">
            {trip.title}
          </h3>
